...
export const metadata = {
  title: 'Terms of Service — LarkFlow',
  description: 'Terms of Service for LarkFlow WhatsApp CRM platform.',
};
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            <p>
              These Terms of Service ("Terms") govern your access to and use of LarkFlow ("Service"),
              operated by ByteLark ("we", "us", or "our"). By creating an account or using LarkFlow,
          ...
          <section>
            ...
            <p>
              LarkFlow is a WhatsApp Business CRM platform that allows businesses to manage WhatsApp
              conversations, contacts, campaigns, and automations using their own Meta WhatsApp Business
              API credentials. LarkFlow acts as a software interface — it does not provide WhatsApp
          ...
          <section>
            ...
            <p>By connecting your WhatsApp Business API credentials to LarkFlow, you agree that:</p>
            <ul className="list-disc pl-5 mt-2 space-y-2">
              ...
              <li>You will not use LarkFlow to send spam, unsolicited messages, or violate WhatsApp's messaging policies.</li>
              ...
              <li>LarkFlow is not responsible for Meta's decisions regarding your WhatsApp Business account, including suspension or termination.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">4. Acceptable Use</h2>
            <p>You agree not to use LarkFlow to:</p>
            <ul className="list-disc pl-5 mt-2 space-y-2">
              ...
              <li>Use the Service to compete with LarkFlow or build a similar product</li>
            </ul>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              You retain ownership of all data you input into LarkFlow, including contacts, messages,
          ...
          <section>
            ...
            <p>
              We strive to maintain high availability of LarkFlow, but we do not guarantee uninterrupted
          ...
          <section>
            ...
            <p>
              Certain features of LarkFlow may require a paid subscription. Pricing, billing cycles,
              and refund policies will be communicated at the time of purchase. Failure to pay may
              result in suspension of your account.
            </p>
            <p className="mt-3">
              LarkFlow fees are separate from any fees charged by Meta or your WhatsApp messaging provider.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              LarkFlow, its logo, and all platform content are the property of ByteLark. You may not
              copy, modify, or redistribute any part of the Service without our written permission.
            </p>
            <p className="mt-3">
              WhatsApp is a registered trademark of Meta Platforms, Inc. LarkFlow is not affiliated
          ...
          <section>
            ...
            <p>
              LarkFlow is provided "as is" and "as available" without warranties of any kind, either
          ...
          <section>
            ...
            <p>
              ...
              by email or by posting a notice in the platform. Continued use of LarkFlow after
