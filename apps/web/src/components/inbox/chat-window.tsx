        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-2">
              ...
              {channel && (
                <span
                  className="text-[10px] font-medium px-1.5 py-0.5 rounded-full flex items-center gap-1 shrink-0"
                  style={channel.is_active
              ...
              <div
                className={cn(
                  ...
                  isNoteMsg ? 'bg-yellow-50 border border-yellow-200 text-yellow-900'
                    : isOut ? 'text-white rounded-br-sm'
                    : 'bg-muted rounded-bl-sm',
                )}
                style={isOut && !isNoteMsg ? { backgroundColor: '#075E54' } : undefined}
              >
                {isNoteMsg && (
